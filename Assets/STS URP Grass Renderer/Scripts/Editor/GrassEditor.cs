...
public class GrassManagerEditor : Editor
{
    ...
    private void DrawSettingsGUI() {
        ...
        if (lodOpen) {
            ...
            EditorGUILayout.Space(5);
            system.grassSettings.clipDistance = Mathf.Max(0, EditorGUILayout.FloatField("Clip Distance", system.grassSettings.clipDistance));
            system.grassSettings.clipBlend = EditorGUILayout.Slider("Clip Blend", system.grassSettings.clipBlend, 0.01f, 100f);
        }
        else EditorGUILayout.Space(2f);
    }
